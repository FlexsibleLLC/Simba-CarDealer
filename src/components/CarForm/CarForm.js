  ...
  return (
    <Form onSubmit={onSubmit}>
      <Form.Group>
        ...
        <Form.Control type="text" required onChange={onManufacturerChange} value={manufacturer} />
      </Form.Group>
      <Form.Group>
        <Form.Label>
            <RequiredLabel text="Model" />
        </Form.Label>
        <Form.Control type="text" required onChange={onModelChange} value={model} />
      </Form.Group>
      <Form.Group>
        <Form.Label>
            <RequiredLabel text="VIN" />
        </Form.Label>
        <Form.Control type="text" required title={'Vehicle Identification Number'} onChange={onVINChange} value={vin} />
      </Form.Group>
      <Form.Group>
        <Form.Label>
            <RequiredLabel text="Car Dealer Name" />
        </Form.Label>
        <Form.Control type="text" required onChange={onDealerChange} value={dealer} />
      </Form.Group>
      <Form.Group>
